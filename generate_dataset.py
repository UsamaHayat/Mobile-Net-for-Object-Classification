...
def generate_database_now(path_to_source_training_package, image_size, path_to_database_training_package):
    ...
    dataset_images_folder = os.path.join(path_to_source_training_package, "dataset_gen")
    ...
    for i, xml_file in enumerate(xml_files):
        ...
        output.append((path, width, height,class_name, class_names[class_name]))
    ...
    #lengths.append(i)
    rospy.loginfo("Object elements==>"+str(length))
    ...
    with open(train_csv_output_file, "w") as train, open(validation_csv_output_file, "w") as validate:
        ...
        #        path, width, height, class_name, class_id = output[s]
        ...
        #        data_list = [absolute_original_path, width, height, class_name, class_names[class_name]]
